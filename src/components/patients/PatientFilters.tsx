...
export type FilterStatus = 'All' | 'Active' | 'Admitted' | 'Inactive'
...
const filters: { label: FilterStatus; color: string; active: string }[] = [
  {
    label: 'All',
    color: 'text-white/50',
  ...
  },
  {
    label: 'Inactive',
    color: 'text-white/50',
    active: 'bg-white/[0.04] text-white/40 border-white/[0.08]',
  },
]
