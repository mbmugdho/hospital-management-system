      ...
      {stats.map((stat) => {
        ...
        return (
          <motion.div
            ...
            className={`group relative bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6 
          ...
          >
            ...
            <div
              className={`absolute bottom-0 left-0 h-[2px] w-0 group-hover:w-full 
                ...
                ${stat.color === 'indigo' ? 'bg-gradient-to-r from-indigo-500/60 to-transparent' : ''}
                ${stat.color === 'violet' ? 'bg-gradient-to-r from-violet-500/60 to-transparent' : ''}
                ${stat.color === 'emerald' ? 'bg-gradient-to-r from-emerald-500/60 to-transparent' : ''}
                ${stat.color === 'sky' ? 'bg-gradient-to-r from-sky-500/60 to-transparent' : ''}
              `}
            />
          </motion.div>
        )
